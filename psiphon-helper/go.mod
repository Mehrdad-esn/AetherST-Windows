module github.com/Mehrdad-esn/AetherST-Windows/psiphon-helper

go 1.26.0

replace github.com/Psiphon-Labs/psiphon-tunnel-core => ./upstream

require github.com/Psiphon-Labs/psiphon-tunnel-core v0.0.0-20260317184552-c2ba044b5866
