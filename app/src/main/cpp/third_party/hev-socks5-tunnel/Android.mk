...
ifeq ($(filter $(modules-get-list),libyaml),)
    include $(TOP_PATH)/third-part/yaml/Android.mk
endif
ifeq ($(filter $(modules-get-list),liblwip),)
    include $(TOP_PATH)/third-part/lwip/Android.mk
endif
ifeq ($(filter $(modules-get-list),libhev-task-system),)
...
LOCAL_STATIC_LIBRARIES := libyaml liblwip libhev-task-system
