...
object TunHelper {
    ...
    fun start(socksTargetPort: Int, mtu: Int = TUN_MTU) {
        ...
        try {
            ...
            File(dataDir, HEV_YAML).writeText(buildHevConfig(socksTargetPort, mtu.coerceIn(576, 9000)))
    ...
    private fun buildHevConfig(socksTargetPort: Int, mtu: Int = TUN_MTU): String {
