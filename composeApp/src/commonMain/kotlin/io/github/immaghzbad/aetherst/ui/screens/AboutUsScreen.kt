...
private const val WindowsPortUrl = "https://github.com/Mehrdad-esn/AetherST-Windows"
            ...
            item {
                SectionCard {
                    ...
                    IosActionRow(
                        iconBg = IosActiveBlue.copy(alpha = 0.16f),
                        title = "Windows Port",
                        subtitle = "github.com/Mehrdad-esn (AetherST-Windows)",
                        onClick = { uriHandler.openUri(WindowsPortUrl) }
                    )
                }
            }
            item {
                SectionCard {
                    SectionTitle("Windows Port")
                    Text(
                        text = "This Windows build is a community port of PowerSigma's AetherST " +
                            "(github.com/immaghzbad/AetherST), maintained by Mehrdad-esn " +
                            "(github.com/Mehrdad-esn/AetherST-Windows). " +
                            "It adds an exclusive OpenVPN Hybrid mode (OpenVPN chained over the app proxy); " +
                            "OpenVPN Community binaries are downloaded at runtime from their official site " +
                            "and are not bundled. All upstream credits above remain with their authors.",
                        style = MaterialTheme.typography.bodyMedium,
                        color = colors.textSecondary,
                        fontSize = 13.sp,
                        lineHeight = 20.sp,
